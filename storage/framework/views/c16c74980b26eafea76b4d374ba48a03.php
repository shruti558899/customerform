...
<body>
    ...
    <form action="<?php echo e(route('stripe.payment')); ?>" method="POST" id="payment-form">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\laravelproject\megamart\resources\views/payment.blade.php ENDPATH**/ ?>